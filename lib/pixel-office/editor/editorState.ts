import { EditTool, PetKind, TileType } from '../types'
import type { TileType as TileTypeVal, OfficeLayout, FloorColor, PetKind as PetKindType } from '../types'
...
export class EditorState {
  ...
  selectedAgentCharacterId: number | null = null
  selectedPetKind: PetKindType = PetKind.CAT
  selectedPetSkin = 0
  ...
  clearSelection(): void {
    ...
    this.selectedAgentCharacterId = null
  }
